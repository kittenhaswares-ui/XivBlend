...
XivBlend's prototype-specific orchestration, self-only UI, IPC manifest capture and Blender worker integration are distributed under the same AGPL-compatible terms.
